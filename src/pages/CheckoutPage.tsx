...
const CheckoutPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setProcessing(true);
    setTimeout(() => {
      const orderId = placeOrder(name, tableNumber, paymentMethod);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <form onSubmit={handleSubmit} className="max-w-lg mx-auto px-4 py-6 space-y-6">
        ...
        <div className="glass rounded-2xl p-5 space-y-4 animate-fade-in" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <span className={`font-heading font-medium text-sm ${paymentMethod === "online" ? "text-primary" : "text-muted-foreground"}`}>
                Online Ödeme
              </span>
            </button>
            <button
            ...
            >
              ...
              <span className={`font-heading font-medium text-sm ${paymentMethod === "cash" ? "text-primary" : "text-muted-foreground"}`}>
                Nakit
              </span>
            </button>
          </div>
        ...
        <button
          type="submit"
          disabled={processing || !name.trim() || !tableNumber.trim()}
